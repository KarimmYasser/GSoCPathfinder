...
from models import RankedOrganization, ScoreBreakdown, UserProfile
...
class MatchingEngine:
    ...
    def rank_organizations(
        self, user_profile: UserProfile, vector_results: list[dict], graph_results: list[dict]
        ...
        for name, data in orgs_map.items():
            ...
            org = RankedOrganization(
                ...
                matched_topics=list(
                    set(user_profile.topics_of_interest).intersection(
