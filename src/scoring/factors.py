...
from models import UserProfile, NormalizedOrganization
...
class ScoringFactors:
    ...
    @staticmethod
    def f1_skill_overlap(user_skills: list[str], org_technologies: list[str], raw_cv_text: str = "") -> float:
        """
    ...
    @staticmethod
    def f3_recency_frequency(years_active: list[int], current_year: int, weights: ScoringWeights) -> float:
        """
    ...
    @staticmethod
    def f6_org_stability(years_active: list[int], current_year: int, weights: ScoringWeights) -> float:
        """
