...
const GraphViz = ({ skills, rankings }) => {
  ...
  return (
    <Paper ref={containerRef} elevation={0} variant="outlined" sx={{ width: '100%', height: 600, overflow: 'hidden', position: 'relative', borderColor: 'divider' }}>
      {/* Legend overlays */}
      <Box position="absolute" top={16} left={16} zIndex={10} bgcolor="rgba(255,255,255,0.92)" p={2} borderRadius={2} border="1px solid" borderColor="divider" boxShadow="0 2px 8px rgba(0,0,0,0.08)">
        ...
        <Typography variant="caption" display="flex" alignItems="center" gap={1} fontFamily="'Roboto Mono', monospace" mb={0.5}>
        ...
        <Typography variant="caption" display="flex" alignItems="center" gap={1} fontFamily="'Roboto Mono', monospace">
      ...
      <ForceGraph2D
        ...
        nodeCanvasObject={(node, ctx, globalScale) => {
          ...
          if (showLabel) {
            ...
            ctx.fillStyle = isHighlighted ? '#1a73e8' : '#202124';
        ...
        linkColor={link => {
          ...
          if (hoverNode) return 'rgba(0, 0, 0, 0.02)';
